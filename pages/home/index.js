...
export default function Home() {
  ...
  return (
    <Layout
      theme={theme}
      seo={{
        title: 'Obralink - Construction',
        description:
          'Automatizando la ejecución de proyectos de construcción',
      }}
      className={s.home}
    >
      ...
      <section className={s.hero}>
        <div className="layout-grid-inner">
          ...
          <span className={cn(s.sub)}>
            <HeroTextIn introOut={introOut}>
              <h1 className={cn('h4', s.subtitle)}>Automatizando la ejecución de proyectos de construcción</h1>
            </HeroTextIn>
            <HeroTextIn introOut={introOut}>
              <h2 className={cn('p-xs', s.tm)}>
                <span>©</span> {new Date().getFullYear()} Obralink
              </h2>
            </HeroTextIn>
          </span>
        </div>
        ...
        <div className={cn(s.bottom, 'layout-grid')}>
          ...
          <h1 className={cn(s.description, 'p-s')}>
            <HeroTextIn introOut={introOut}>
              <p className="p-s"> Una nueva herramienta</p>
            </HeroTextIn>
            <HeroTextIn introOut={introOut}>
              <p className="p-s">para la construcción</p>
            </HeroTextIn>
          </h1>
          <Button
      ...
      <section className={s.why} data-lenis-scroll-snap-align="start">
        <div className="layout-grid">
          <h2 className={cn(s.sticky, 'h2')}>
            <AppearTitle>Ventajas </AppearTitle>
          </h2>
